...
public class ReportsByWeekController implements Initializable {

  @FXML
  private PieChart pieChart;
  private ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList();
  private final String getDescriptionCounts = "SELECT appointment.description, appointment.start, COUNT(*) AS \"count\" FROM appointment WHERE appointment.start BETWEEN NOW() and DATE_ADD(NOW(), INTERVAL 7 DAY) GROUP BY appointment.description;";

  @Override
  public void initialize(URL location, ResourceBundle resources) {
    getPieChartData();
    pieChart.setTitle("Appointment Types by Week");
